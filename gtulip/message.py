...
from gtulip.body import ChunkedReader, LengthReader, EOFReader, Body
...
class Request(Message):
    ...
    def parse(self, unreader):
        buf = BytesIO()
        yield from self.get_data(unreader, buf, stop=True)

        # get request line
        line, rbuf = yield from self.read_line(
            unreader, buf, self.limit_request_line)
